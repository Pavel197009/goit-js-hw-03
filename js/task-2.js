...
function makeArray(firstArray, secondArray, maxLength) {
  let array = firstArray.concat(secondArray);   // создание сцепки массивов
  if (array.length > maxLength) {
    return array.slice(0, maxLength);           // возврат среза объединенного массива при избыточной длине
  }
  return array;                                 // возврат объединенного массива по умолчанию  
}   
